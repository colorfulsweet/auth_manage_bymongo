...
var FuncTools = function(){
	...
	this.buildDialogSave = function(config){
		var defaultCfg = {
				formId : "",
				dialogId : "",
				saveLine : false
		};
		_.extendOwn(defaultCfg, config);
		var saveFunc = null;
		if(defaultCfg.saveLine) {
			saveFunc = function(e){
				...
				var $form = $("form#" + defaultCfg.formId);
			...
			saveFunc = function(e){
				...
				$.post($form.attr("action"),params,function(res){
					res.callBack = function(){
						$("#"+defaultCfg.dialogId).dialog("close");
					};
					new $.TipBox(res);
				},"json");
			};
